...
%Loss 
%net.addLayer('objective', dagnn.Loss('loss', 'softmaxlog'), {predVar,'label'}, 'objective') ;
...
% weight fusion, get predict, and calculate IOU
% assume our result is postive (1 correct)
