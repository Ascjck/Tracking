...
while true
    ...
    if frame > 1
        ...
        iter = 1;
        location_params = {params.newton_iterations,img_support_sz,output_sz, currentScaleFactor,sample_pos,min_scale_factor,max_scale_factor,base_target_sz,scaleFactors};
        ...
        while iter <= params.refinement_iterations && any(old_pos ~= pos)
            ...
            location_1 = get_location(scores_fs_1,location_params);
            location_2 = get_location(scores_fs_2,location_params);
